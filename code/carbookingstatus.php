...
$q="select *from carbook  where dr_id=$val"; 
$rs=$db->selectData($q);
     ...
     <td>&nbsp;&nbsp;&nbsp;<?php echo $row['time'];?>&nbsp;&nbsp;&nbsp;</td>
      ...
      <td>&nbsp;&nbsp;&nbsp;<?php echo $row['trip'];?>&nbsp;&nbsp;&nbsp;</td>
       <td>&nbsp;&nbsp;&nbsp;<?php echo $row['wt'];?>&nbsp;&nbsp;&nbsp;</td>
		 ...
		 {
			 ?>
             <td><a href="dapr.php?id=<?php echo $row['book_id'];?>">Available</a></td>
    <td><a href="drjct.php?id=<?php echo $row['book_id'];?>">Unavailable</a></td>
    <?php } ?>
    </tr>
    <?php } ?>
</table></div>
