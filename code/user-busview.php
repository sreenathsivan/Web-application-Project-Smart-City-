...
<html lang="en">
 ...
 <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/bus.jpg');" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
              <p class="breadcrumbs"><span class="mr-2"><a href="userhome.php">Home</a></span> <span></span></p>
              <h1 class="mb-3">Buses</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 tabulation-search">
            <div class="element-animate">
              <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link p-3 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span></span>Bus</a>
            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="block-17">
                  <form action="user-searchbusview.php" method="get" class="d-block d-lg-flex">
                    <div class="fields d-block d-lg-flex">

                      <div class="select-wrap one-third">
                        <div class="icon"><span class="ion-ios-arrow-down"></span></div><font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search Location</font>
                        <select name="toplace" id="" class="tbox">
	                    ...
	                    while($row2=mysql_fetch_array($rs2))
	                     {
		                   ?>
                       <option><?php echo $row2['toplace'];?></option><?php } ?></select>
                        
                        
                      </div>

                      <div class="check-in one-third"><font color="#FFFFFF">Check In Time</font><input type="time" id="checkin_time" class="form-control" placeholder="Check-in time" name="init"  ></div>
                      <div class="check-in one-third"><font color="#FFFFFF">Check Out Time</font>
                      <input type="time" id="checkin_time" class="form-control" placeholder="Check-in time" name="final"  ></div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2">
                ...
                <br>
                <?php echo $row['fromplace'];?>&nbsp;&nbsp; to &nbsp;&nbsp; <?php echo $row['toplace'];?>
                </p>
              </div>
          </div>      
         <?php } ?> </div>
