...
<html lang="en">
  ...
  <style>
  body {background-image:url(images/profile.jpg);
  background-size:cover;
  }
  .tbox {background-color:black;
	margin-left:100px;
	height:50px;
	width:300px;
	color:white;
	...
	.lbox{background-color:black;
	margin-left:200px;
	color:white;
	width:100px;
	height:50px;
	}
	.ll{margin-left:10px;color:white;
	font-size:18px
	;
	}
  ...
  <div class="container-fluid">
   ...
   <?php
			...
			$db=new DatabaseCon;
			$val=$_SESSION['uid'];
			$s="select * from register where rid='$val'";
			$rs=$db->selectData($s);
...
<tr><td>&nbsp;</td></tr>
 <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
     Reg.ID</td>
    <td><input name="n" type="text" class="tbox" value="<?php echo $row['rid'];?>" readonly/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr><tr><td>&nbsp;</td></tr>
   
  <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
     Name</td>
    <td><input name="name" type="text" class="tbox" value="<?php echo $row['name'];?>"readonly/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr><tr><td>&nbsp;</td></tr>
  <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Place</td>
