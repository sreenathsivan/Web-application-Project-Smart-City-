...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a  href="user-home.php" ><img src="images/logo.png" width="100" height="100"></a>
        ...
        <div class="container">
          <div class="row slider-text align-items-center">
			...
			?>
              ...
              <marquee behavior="scroll" direction="right" scrollamount="1"><a href="events.php"><font color="#FF0000" size="+3">Events</font></a></marquee>
            </div>
          </div>
        </div>
      </div>
...
<section></section>
 ...
 <section class="ftco-section">
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
			...
			while($row=mysql_fetch_array($rs))
			{
                ...
                <a href="events.php" class="block-5">
  ...
  <source src='uploads/<?php echo $row['video']; ?>'  type="video/mp4" >
              ...
              <div class="col-md-6 col-lg-3 ftco-animate">
                <a href="events.php" class="block-5" style="background-image:     url('uploads/<?php echo $row['img'];?>');">
                  <div class="text">
                    <span class="price"><?php echo $row['subject'];?></span>
                    <h3 class="heading"><?php echo $row['name'];?></h3>
                    <div class="post-meta">
