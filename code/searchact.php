...
<html lang="en">
 ...
 table{color:black;
  ...
  <div class="container-fluid">
   ...
   <table border="3" cellpadding="5" style="margin-top:100px">
<tr>
</tr>
<br>
<center><h2><b><u>Car details</u></b></h2></center>
<form action="searchact.php" class="nav-link">
			  <input type="date" name="tt" placeholder="Search Product" size="20">
			</form>
</tr>
<br>
<tr>
...
if(!isset($_GET['tt'])){
	...
	$p=$_GET['tt'];
	$query="select * from carbook  where date  like '%".$p."%'" ;
}
$d=new DatabaseCon;
...
while($row=mysql_fetch_array($rst)){
    ...
    <td>&nbsp;&nbsp;&nbsp;<a href="cust.php?id=<?php echo $row['uid'];?>"><?php echo $row['uid'];?></a>&nbsp;&nbsp;&nbsp;</td>
