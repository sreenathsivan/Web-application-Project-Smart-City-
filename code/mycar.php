...
<th>&nbsp;&nbsp;&nbsp;Car Number&nbsp;&nbsp;&nbsp;</th>
<th>&nbsp;&nbsp;&nbsp;Type&nbsp;&nbsp;&nbsp;</th>
<th>&nbsp;&nbsp;&nbsp;Maximum Allowable Passengers &nbsp;&nbsp;&nbsp;</th>
...
$q="select *from cars where uid=$val"; 
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
    ...
    <td>&nbsp;&nbsp;&nbsp;<?php echo $row['cno'];?>&nbsp;&nbsp;&nbsp;</td>
     <td>&nbsp;&nbsp;&nbsp;<?php echo $row['type'];?>&nbsp;&nbsp;&nbsp;</td>
      <td>&nbsp;&nbsp;&nbsp;<?php echo $row['max_pass'];?>&nbsp;&nbsp;&nbsp;</td>
       <td>&nbsp;&nbsp;&nbsp;<?php echo $row['min'];?>&nbsp;&nbsp;&nbsp;</td>
         <td>&nbsp;&nbsp;&nbsp;<?php echo "<img src='uploads/".$row['img']."' width='50px' height='50px'";?>&nbsp;&nbsp;&nbsp;</td>

     <td><a href="delcar.php?id=<?php echo $row['car_id'];?>">&nbsp;&nbsp;&nbsp; Delete&nbsp;&nbsp;&nbsp;</a></td>
    <td><a href="upcar.php?id=<?php echo $row['car_id'];?>">&nbsp;&nbsp;&nbsp; Update&nbsp;&nbsp;&nbsp;</a></td>
