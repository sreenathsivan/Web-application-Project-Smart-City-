...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a  href="userhome.php" ><img src="images/logo.png" width="100" height="100"></a>
...
<section></section>
      ...
      <div class="container">
        ...
        <div class="row">
         <?php
			...
			$id=$_GET['id'];
			//$val=$_SESSION['uid'];
			$s="select * from event where e_id='$id'";
			$rs=$db->selectData($s);
			...
			{if($row['type']=='video')
				{
                 ...
                 <div class="col-md-6 col-lg-6 mb-4 ftco-animate"> 
                  <video autoplay muted loop id="myvideo" width="600" height="480">
  ...
  <source src='uploads/<?php echo $row['video']; ?>'  type="video/mp4" >
      ...
      <div class="text"> <span class="price"><?php echo $row['subject'];?></span>
          <h3 class="heading"><?php echo $row['name'];?></h3>
           <div class="post-meta"> <span><?php echo $row['event_from'];?></span>           </div>
           <div class="post-meta"> <span><?php echo $row['event_to'];?>&nbsp;Days</span>           </div>
         ...
         <div class="text col-lg-6 ftco-animate" style="background-color:#FFF">
            <div class="text-inner align-self-start">
             <h3 class="font-weight-light"><a href="#"><u>Welcome to <?php echo $row['name'];?></u></a></h3>
             
             
              
              <div class=" icon-arrow-right" ><a href="userhome.php">Home</a></div>
              <div class=" mb-3 text-black"><br><span class="text-black-opacity-05"><small><?php echo $row['event_from'];?>&nbsp;&nbsp;<span class="sep">&nbsp;-&nbsp;</span><?php echo $row['event_to'];?>&nbsp;Days <span class="sep">&nbsp;&nbsp;&nbsp;&nbsp;</span></small></span></div>
              <p><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['subject'];?></p>
              <p>Contact&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['phno'];?></p>
              ...
              <p></p>
               ...
               else
			   {
				?>
                 ...
                 <div class="col-md-6 col-lg-6 mb-4 ftco-animate"> <a href="" class="block-5" style="background-image: url('uploads/<?php echo $row['img'];?>');">
      <div class="text"> <span class="price"><?php echo $row['subject'];?></span>
          <h3 class="heading"><?php echo $row['name'];?></h3>
           <div class="post-meta"> <span><?php echo $row['event_from'];?></span>           </div>
           <div class="post-meta"> <span><?php echo $row['event_to'];?>&nbsp;Days</span>           </div>
