         ...
         <?php
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              <div class="d-flex justify-content-center"><div><?php echo "<img src='uploads/".$row['img']."' width='150px' height='150px'";?></div></div></div>
              <div class="media-body p-2">
                <h3 class="heading"><?php echo $row['name'];?></h3>
                <p><?php echo $row['address'];?><br><?php echo $row['email'];?><br>
                <?php echo $row['phno'];?><br><a href="<?php echo $row['website'];?>"><?php echo $row['website'];?></a></p>
              </div>
            </div>      
         <?php } ?> </div>
          <!--<div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
