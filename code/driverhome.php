...
<html lang="en">
  ...
  <div class="container-fluid">
	...
	$db=new DatabaseCon;
	$val=$_SESSION['uid'];
	$s="select * from login where uid='$val'";
	$rs=$db->selectData($s);
	$row=mysql_fetch_array($rs);
	?>
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/d4.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
              <h1 class="mb-3">Welcome &nbsp;<?php echo $row['uname'];?></h1>
            </div>
          </div>
        </div>
      </div>

      <div class="slider-item" style="background-image: url('images/d1.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
        ...
        <div class="slider-item" style="background-image: url('images/d5.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
      ...
      <div class="slider-item" style="background-image: url('images/d2.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 ftco-animate">
