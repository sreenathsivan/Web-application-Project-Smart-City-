...
<html lang="en">
  ...
  <div class="container-fluid">
   ...
   <form action="tourismaction.php" method="post" enctype="multipart/form-data" onSubmit="return check();">
...
<tr><td>&nbsp;</td></tr>
  ...
  <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Location</td>
    <td><input name="location" type="textarea" class="tbox"required />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
  </tr><tr><td>&nbsp;</td></tr>
  <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Distance  from Konni</td>
    <td><input name="dist" type="text" class="tbox"required />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr><td>&nbsp;</td></tr>
   <tr>
    <td class="ll">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Description</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
    <textarea rows="5" cols="45" name="descr" style="background-color:#C30"required /></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr><tr><td>&nbsp;</td></tr>
  <tr><td><input name="submit" type="submit" value="Add" class="lbox"/></td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td>&nbsp;</td></tr>
</table>
</form></div>
