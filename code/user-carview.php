...
<html lang="en">
  ...
  <body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a  href="userhome.php" ><img src="images/logo2.png" width="100" height="100"></a>
...
<section></section>
   ...
   <section class="ftco-section bg-light">
	...
	if($i>0)
	{
		//echo 'here'; ?>
             ...
             <a href="" class="block-20" style="background-image: url('uploads/<?php echo $row['img'];?>');">
              ...
              <h5><font color="#FF0000">Now on Trip!!!Booking not Allowed</font></h5>
              </div>
             <?php
	}
	else
	{
		?>
       <a href="carbooking.php?id=<?php echo $row['car_id'];?>" class="block-20" style="background-image: url('uploads/<?php echo $row['img'];?>');">
              </a>
        <?php
	}
	?> 
              ...
              <div class="text p-4"  style="background-image:url(images/2.jpg)" >
                <div class="meta">
                <div><a href="#">Car Id&nbsp;:&nbsp;<?php echo $row['car_id'];?></a></div>
                  <div><a href="#">Car Number&nbsp;:&nbsp;<?php echo $row['cno'];?></a>
                  <div><a href="#">Driver&nbsp;:&nbsp;<?php echo $row['dname'];?></a></div>
                  <div><a href="#">Model&nbsp;:&nbsp;<?php echo $row['type'];?></a></div>
                  <div><a href="#">Contact&nbsp;:&nbsp;<?php echo $row['phno'];?></a></div>
                  <div><a href="#">Max Number of Passengers&nbsp;:&nbsp;<?php echo $row['max_pass'];?></a></div>
                  <div><a href="#">Minimum Charge&nbsp;:&nbsp;<?php echo $row['min'];?></a></div>
